...
<!-- Content -->
  <div class="content-container">
    <div class="row">
      <ul class="breadcrumbs twelve columns">
        ...
        <li class="current"><a href="#">Actual Value Initiative</a></li>
      </ul>
    </div>
    <!-- News Container -->
 ...
 <?php echo category_description( get_category_by_slug('avi')->term_id ); ?>
        </div>
        ...
        <li class="active" id="feedTab">
          ...
          <div class="row">
            <div id="stories" class="twelve columns">
              <div class="items">
                <?php
  query_posts( array( 'post_status' => 'publish' , 'category_name' => 'avi' , 'post_type' => array( 'post' , 'external_post') ) );
  if (have_posts()) :
  while (have_posts()) :
  the_post();
  ?>
        ...
        <li id="dataTab">
          ...
          <div class="row">
            <div id="tools-and-data" class="twelve columns">
              <div class="items">
                <?php
  query_posts( array( 'post_status' => 'publish' , 'category_name' => 'avi' , 'post_type' => array( 'wp_tool' , 'external_tool') ) );
